...
$result = $db->query("SELECT  corsi.titolo as titoloCorso,
                              ...
                              lezioni.ora as ora , lezioni.aula as aula, lezioni.id as id,
                              corsi.tipo as tipo,
                      ...
                      where   utenti.id = corsi.idDocente and
                              ...
                              order by titoloCorso, cognomeProf, nomeProf, ora ") or die($db->error);

$code .= "
<style>td, th{border:1px solid; padding: 12px 10px;}</style>
<h3 style='text-align:center; margin-bottom:0px;'>L. S. \"G. Galilei\" - \"Finestra tecnica\"  ".$result->num_rows." </h3>
<h1 style='text-align:center;margin-bottom: 5px; margin-top:15px;'>Elenco dei Corsi</h1>
<h4 style='text-align:center;margin-bottom: 5px;'>Ordinati per titolo</h4>";
